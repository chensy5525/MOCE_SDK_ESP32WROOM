...
#define VL53L0X_I2C_TIMEOUT_MS 1000U
#define VL53L0X_DATA_READY_TIMEOUT_MS 100U
#define VL53L0X_MAX_RETRIES 3U
#define VL53L0X_RANGE_MAX_MM 2000U
#define VL53L0X_MODEL_ID 0xEEU
typedef struct { uint8_t i2c_addr; uint32_t bus_speed_hz; uint32_t timeout_ms; uint32_t data_ready_timeout_ms; bool initialize_i2c; } vl53l0x_cfg_t;
typedef struct { uint16_t distance_mm; uint8_t range_status; bool valid; bool out_of_range; } vl53l0x_result_t;

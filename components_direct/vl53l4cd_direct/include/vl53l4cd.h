...
#define VL53L4CD_BUS_SPEED_HZ 400000U
#define VL53L4CD_I2C_TIMEOUT_MS 1000U
#define VL53L4CD_DATA_READY_TIMEOUT_MS 250U
#define VL53L4CD_MAX_RETRIES 3U
#define VL53L4CD_RANGE_MAX_MM 1300U
#define VL53L4CD_MODEL_ID 0xEBAAU
typedef struct { uint8_t i2c_addr; uint32_t bus_speed_hz; uint32_t timeout_ms; uint32_t data_ready_timeout_ms; bool initialize_i2c; } vl53l4cd_cfg_t;

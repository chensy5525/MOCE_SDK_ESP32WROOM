...
This is the direct-connection variant. It is intentionally separate from the CH32 gateway components under `components/`, which are used when the sensor is behind a CH32 node.
...
- `docs/context/modules/vl53l0x_direct_i2c.md`
- `docs/context/protocols/vl53l0x_direct_i2c.md`
